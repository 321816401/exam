...
<div class="main">
    ...
    <div class="form">
        <a href="addCurriculum.jsp" class="btn btn-success">添加</a>
        <table>
            <thead>
            <tr> <th>名称</th><th>介绍</th><th>任课老师</th><th>创建时间</th> <th>更新时间</th></tr>
            </thead>
            <tbody>
            ...
            <s:iterator value="%{#curriculumList.curriculums}" status="rowStatus" var="c">
                <tr id="${c.id}">
                    ...
                    <td>
                        <a href="editCurriculum.jsp?id=${c.id}" class="btn btn-success">修改</a>
...
<script>
    function del(id){
        $.ajax({
            url:'/ssh/Curriculum.delete.action?id='+id,
            type:'POST',
            dataType:'json',
