...
<div class="main">
    <div class="left-menu">
        <div class="tree-menu">
            ...
            <div class="tree-body">
                ...
                <div class="tree-leaf active"><a href="curriculum.jsp">课程管理</a></div>
    ...
    <form class="form">
        <input type="hidden" name="curriculum.user.id" id="user">
        <div><span>名称</span><input type="text" name="curriculum.name"></div>
        <div><span>介绍</span><input type="text"  name="curriculum.content"></div>
...
<script>
    ...
    function save(){
        $.ajax({
            url:'/ssh/Curriculum.save.action?'+$("form").serialize(),
            type:'POST',
            dataType:'json',
